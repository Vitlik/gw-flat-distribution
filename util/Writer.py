...
def save_data(file, hh_wishes, flats, allocations, max_happiness, swapping):
    ...
    ws.append(["HaushaltsID", "WohnungsID",
               "Geb_Glück", "Etage_Glück", "Nachbar_Glück", "kleiWg_Glück", "TierNähe_Glück", "Wg_Glück", "Summe", "_",
               "Geb_Wunsch", "Geb_tatsächlich", "Etage_Wunsch", "Etage_tatsächlich", "Nachbar_Wunsch",
               "kleiWg_Wunsch", "kleiWg_tatsächlich", "TierNähe_Wunsch", "Tier Distanz", "Wg_Wunsch"])
    ...
    if not swapping:
        ...
        tab = Table(displayName="Allocations_neu", ref="A4:T" + str(counter))
